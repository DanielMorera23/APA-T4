...
![Tests unitarios](IMAGEN%20APA%204.jpeg)

#### Código desarrollado

```python
"""
Generación de números aleatorios mediante el algoritmo LGC.

Autor: Daniel Morera Torra

Este módulo implementa dos formas de generar secuencias pseudoaleatorias
usando el algoritmo de generación lineal congruente (LGC): una clase
iterable llamada Aleat y una función generadora llamada aleat.
"""
